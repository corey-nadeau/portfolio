  ...
  return (
    ...
    <div className=''>
      ...
      <div className='pt-64 items-center'>
        {/* bio */}
        <div className='flex'>
          <div className='text-white w-full text-center my-48 mx-72 bg-opacity-70 p-8 bg-black rounded-xl flex'>My Name is Corey Nadeau, and I am a full stack software 
        ...
        <div className='flex py-24'>
          ...
          outdoors is not only good for the body, but also for the soul, and I encourage everyone to get outside and explore the natural world around you.</div>
            <div className=' w-full pr-32'>
