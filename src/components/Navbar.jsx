    ...
    return (
        <div class="w3-top w-full">
            <div class="w3-black w3-card text-center text-md">
                <a href="#" class="w3-bar-item w3-button w3-padding-large md:text-sm"><b>Corey Nadeau</b> - Full-Stack Software Engineer</a>
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                ...
                <a href="http://phonebook-app-api.glitch.me/" target="_blank" class="w3-bar-item w3-button md:text-sm">Flask Phonebook API <tiny className=" fa-solid fa-arrow-up-right-from-square text-xs"></tiny></a>
