...
git clone https://github.com/corey-nadeau/portfolio-site.git
...
npm run dev
Usage
To use the portfolio site, simply navigate to the URL where it's hosted, or open it in your local development server. You can use the dropdown menu to view projects and click on them to learn more about each project. You can also use the contact form to send an email to me using EmailJS.
...
React Slider Images documentation
